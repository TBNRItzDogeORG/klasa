...
exports.DEFAULTS = {
  ...
  QUERYBUILDER: {
    datatypes: {
      ...
      json: {
        type: "JSON",
        resolver: (value) => `'${JSON.stringify(value).replace(/'/g, "''")}'`,
      },
    ...
    queryBuilderOptions: {
      array: () => "TEXT",
      resolver: (value) =>
        `'${(isObject(value) ? JSON.stringify(value) : String(value)).replace(
          /'/g,
          "''"
        )}'`,
...
exports.TIME.CRON.tokensRegex = new RegExp(
  Object.keys(exports.TIME.CRON.tokens).join("|"),
  "g"
);
